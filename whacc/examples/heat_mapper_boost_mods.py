...
all_models = utils.lister_it(utils.print_h5_keys(h5_file, 1, 0), keep_strings='val_ANDREW', remove_string='viterbi')
...
pred_bool = foo_arg_max_and_smooth(pred_bool_temp, 1, threshold, key_name,L_key_ = L_key_)
