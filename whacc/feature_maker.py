...
print('this is a test to see if it is updating properly ')
...
class feature_maker():
    def __init__(self, h5_in, frame_num_ind=None, frame_nums=None, operational_key='FD__original', disable_tqdm=False,
        ...
        if utils.h5_key_exists(h5_in, 'has_data_been_randomized'):
            print(image_tools.get_h5_key_and_concatenate(h5_in, 'has_data_been_randomized'))
            print(image_tools.get_h5_key_and_concatenate(h5_in, 'has_data_been_randomized').tolist())
            print(image_tools.get_h5_key_and_concatenate(h5_in, 'has_data_been_randomized').tolist() is False)
